...
#' out the details of the text request.
#' @param config Optional. Default to \code{list()}. A list of configuration parameters for text generation.
#'
#' @return If successful, a text response will be returned. If the API response indicates
...
#'
#' \href{https://colab.research.google.com/github/GitData-GA/GenAI/blob/gh-pages/r/example/txt.ipynb}{Live Demo in Colab}
#'
#' @examples
#' \dontrun{
