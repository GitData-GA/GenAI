...
#' function \code{\link{chat.history.print}} or simply use \code{verbose = TRUE} in this function. To reset the chat history along with
#' the chat history along with the generative AI object, use the function \code{\link{chat.history.reset}}.
#'
...
#'
#' \href{https://colab.research.google.com/github/GitData-GA/GenAI/blob/gh-pages/r/example/chat_edit.ipynb}{Live Demo in Colab}
#'
#' @examples
#' \dontrun{
