...
def explain_code(model_parameter, temperature, prompt, language = "Python"):
    ...
    if provider == "google":
        ...
        request_body = {
            "contents": {"parts": [{"text": f"Explain the following {language} code\n# Code starts #\n{prompt}\n# Code ends #\n"}]},
        ...
        request_body = {
            ...
            "messages": [
                ...
                {"role": "user", "content": f"Explain the following {language} code\n# Code starts #\n{prompt}\n# Code ends #\n"}
            ],
