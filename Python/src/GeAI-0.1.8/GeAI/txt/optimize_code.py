...
def optimize_code(model_parameter, temperature, prompt, goal, language = "Python"):
    ...
    if provider == "google":
        ...
        request_body = {
            "contents": {"parts": [{"text": f"Optimize the following {language} code.\nThe goal is: {goal}\n# Code starts #\n{prompt}\n# Code ends #\n"}]},
        ...
        request_body = {
            ...
            "messages": [
                ...
                {"role": "user", "content": f"Optimize the following {language} code.\nThe goal is: {goal}\n# Code starts #\n{prompt}\n# Code ends #\n"}
            ],
